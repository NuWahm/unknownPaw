...
public class PostImageController {
  ...
  public ResponseEntity<?> upload(@PathVariable String postType,
    ...
    try {
      ...
      String fileName = imageService.saveImage(file, ImageType.POST, "postType", targetId);
  ...
  public ResponseEntity<?> replaceImage(@PathVariable String postType,
                                        ...
                                        @RequestParam("targetId") Long targetId) {
    try {
      String newFileName = imageService.replaceImage(newFile, ImageType.POST,oldFileName, "postType", targetId);
