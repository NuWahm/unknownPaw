...
public class QPet extends EntityPathBase<Pet> {
    ...
    public QPet(Class<? extends Pet> type, PathMetadata metadata, PathInits inits) {
        ...
        this.petOwnerId = inits.isInitialized("petOwnerId") ? new QPetOwner(forProperty("petOwnerId")) : null;
        this.petSitterId = inits.isInitialized("petSitterId") ? new QPetSitter(forProperty("petSitterId")) : null;
    }
